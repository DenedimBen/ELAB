...
abstract class AppLocalizations {
  ...
  ///
  /// In tr, this message translates to:
  /// **'Direnç, Güç, Bobin Hesaplamaları'**
  String get calcDesc;
  ...
  /// No description provided for @knowledgeDesc.
  ///
  /// In tr, this message translates to:
  /// **'Formüller, Teoriler ve Pinoutlar'**
  String get knowledgeDesc;

  /// No description provided for @componentsDesc.
  ///
  /// In tr, this message translates to:
  /// **'Transİstör, Diyot, Entegreler...'**
  String get componentsDesc;
  ...
  /// No description provided for @componentsInfo.
  ///
  /// In tr, this message translates to:
  /// **'Komponent Bilgisi'**
  String get componentsInfo;
